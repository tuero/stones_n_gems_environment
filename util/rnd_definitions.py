...
# Item groups
rnd_doors_visible = [tilestr_to_visiblecellid[name] for name in [
    "gate_red_closed", "gate_yellow_closed", "gate_green_closed", "gate_blue_closed"
]]
rnd_doorsopen_visible = [tilestr_to_visiblecellid[name] for name in [
    "gate_red_open", "gate_yellow_open", "gate_green_open", "gate_blue_open"
]]
...
rnd_doors_hidden = [tilestr_to_hiddencellid[name] for name in [
    "gate_red_closed", "gate_yellow_closed", "gate_green_closed", "gate_blue_closed"
]]
rnd_doorsopen_hidden = [tilestr_to_hiddencellid[name] for name in [
    "gate_red_open", "gate_yellow_open", "gate_green_open", "gate_blue_open"
]]
